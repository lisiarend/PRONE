...
#' @title Example data.table of DE results of of a real-world proteomics data set
#' @description
...
#' @title Example data.table of DE results of of a spike-in proteomics data set
#' @description
