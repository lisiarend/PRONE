...
Due to current issues with DEqMS on Bioconductor and the ongoing submission of PRONE to Bioconductor, the main branch of PRONE no longer includes DEqMS functions. If you need to perform DEqMS, please use the with_DEqMS branch.
...
To get familiar with the functionalities of the R package, check out the article [Getting started with PRONE](https://lisiarend.github.io/PRONE/articles/PRONE.html).
