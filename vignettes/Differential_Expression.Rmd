...
```{r}
new_de_res <- apply_thresholds(de_res = de_res, logFC = TRUE, logFC_up = 0, logFC_down = 0, p_adj = TRUE, alpha = 0.05)
```
...
```{r}
plot_overview_DE_bar(de_res, ain = NULL, comparisons = comparisons, plot_type = "facet_regulation")
```
...
```{r}
plot_heatmap_DE(se_norm, de_res, ain = c("RobNorm", "IRS_on_RobNorm"), comparison = "PTB-HC", condition = NULL, label_by = NULL, pvalue_column = "adj.P.Val")
```
